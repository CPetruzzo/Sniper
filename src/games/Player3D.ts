...
export class Player3D extends PhysicsContainer implements IHitBox {
    ...
    constructor() {
        ...
        // this.acceleration.y = Player3D.GRAVITY;
    ...
    public jump() {
        if (this.canJump) {
            ...
            // this.speed.y = -(Player3D.GRAVITY * 0.7)
            this.canJump = false;
    ...
    public runLeft() {
        ...
        this.speed.x = -Player3D.MOVE_SPEED;
        this.speed.y = -Player3D.MOVE_SPEED;
        this.scale.set(-2, 2);
